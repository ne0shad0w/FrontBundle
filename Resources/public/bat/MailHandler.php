<?php
	...
	//if($host=="" or $username=="" or $password==""){
		...
		$subject = 'Vous avez recu un message sur votre site de la part de ' . $_POST["name"];
	...
	/*}else{	
		...
		$subject = 'Vous avez reçu un message sur votre site de la part de ' . $_POST["name"];
		$headers = array (
