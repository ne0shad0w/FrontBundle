...
function apply(file,external){
  ...
  if (external!=""){
	  ...
	  if ($.inArray(ext, ext_img) > -1){
	    fill='<img src="../../../../ZephyrBundle/Resources/public/js/'+url+'" alt="'+alt_name+'" />';
	  }else {
			if ($.inArray(ext, ext_video) > -1){
			  fill='<video controls source src="../../../../ZephyrBundle/Resources/public/js/'+url+'" type="video/'+ext+'">'+alt_name+'</video>';
			}else {
			  if ($.inArray(ext, ext_audio) > -1 ){
					if (ext=='mp3') { ext='mpeg'; }
					fill='<audio controls src="'+url+'" type="audio/'+ext+'">'+alt_name+'</audio>';
			  }else {
					fill='<a href="../../../../ZephyrBundle/Resources/public/js/'+url+'" title="'+alt_name+'">'+alt_name+'</a>';
			  }
			}
