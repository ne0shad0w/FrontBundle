...
////////callbacks
	...
	for (loopMove=0;loopMove<amountSlide;loopMove++)
	{
		...
		if(allLinks[loopMove]!=''){
			...
			//
			$('.camera_target_content .cameraContent:eq('+loopMove+')',wrap).append('<a class="camera_link" href="../../../../ZephyrBundle/Resources/public/js/'+allLinks[loopMove]+'" '+dataBox+' target="'+allTargets[loopMove]+'"></a>');
		}
